module github.com/emersion/bakah
...
require (
	...
	go.podman.io/common v0.66.1-0.20251202202200-df55d6c661e8 // indirect
	go.podman.io/image/v5 v5.38.1-0.20251202202200-df55d6c661e8 // indirect
